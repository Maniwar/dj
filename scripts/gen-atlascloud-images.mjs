...
const SCENES = [
  ...
  { out: 'public/assets/video/frames/club-crowd.jpg', size: '2720*1530', refs: [K, D],
    prompt: `${KEEP} Camcorder view over a packed INDOOR club crowd toward the mainstage: a GIANT LED JUMBOTRON above the stage shows a big live close-up of KIKI (image 1, silver) singing (her whole figure and both arms stay strictly INSIDE the rectangular screen bezel — nothing extends past the screen edges), while DJ DIETER (image 2, leather jacket + wraparound shades) works the decks below; green and magenta lasers, fog, a few phone flashes. Keep the foreground clear — do NOT fill it with a wall of raised hands. ${STYLE} ${NEG}` },
